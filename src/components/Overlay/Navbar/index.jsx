...
const navList = [
  ...
  { title: "Green Team", icon: <HiOutlineUsers />, position: 2.1 },
  { title: "Functionalities", icon: <HiOutlineChip />, position: 6.7 },
  { title: "GreenHub", icon: <HiOutlineDesktopComputer />, position: 7.8 },
  { title: "Stay Informed", icon: <HiOutlineCollection />, position: 9 },
];
